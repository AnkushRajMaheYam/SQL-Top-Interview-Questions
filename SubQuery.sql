...
--86--
/*
DISPLAY LOCATION OF THE EMPLOYEE WHO EARN COMMISSION
*/
SELECT LOC
FROM DEPT
WHERE DEPTNO IN (SELECT DEPTNO
...
--87-- ***
/*
LIST THE EMPLOYEE WHO DOES NOT DIRECTLY REPORT TO PRESIDENT, HAVE COMMISSION AND SALARY MORE THAN MAX SALARY OF ALL THE CLERK WITHOUT USING NULL OR NOT NULL.
*/
SELECT ENAME
FROM EMP
WHERE MGR IN (SELECT EMPNO
                    FROM EMP
                            WHERE MGR IN (SELECT EMPNO
                                                FROM EMP
                                                    WHERE JOB = 'PRESIDENT')) AND COMM >= 0 AND SAL >ALL (SELECT MAX(SAL)
                                                            FROM EMP
                                                                WHERE JOB = 'CLERK');
...
--89--
/*
LIST THE EMPLOYEE DEPTNAME AND LOC OF ALL THE EMPLOYEE WHO ARE CLERK, REPORTING TO BLAKE AND SALARY IS LESSER THAN MARTIN SALARY
*/
SELECT DNAME, LOC
FROM DEPT
WHERE DEPTNO IN (SELECT DEPTNO
                    FROM EMP
                        WHERE JOB='CLERK' AND EMPNO IN (SELECT MGR
                            FROM EMP
                                WHERE EMPNO = (SELECT MGR
                                                    FROM EMP
                                                        WHERE ENAME='BLAKE')) AND SAL<(SELECT SAL
...
--90-- ??
/*
DISPLAY LOC AND DNAME WHOSE JOB IS MANAGER AND HAS SAL LESS THAN CLERK.
*/
SELECT LOC, DNAME
FROM DEPT
WHERE DEPTNO IN (SELECT DEPTNO
...
--91--
/*
DISPLAY EMPLOYEES LOCATION WHO HAS SOME COMMISSION.
*/
SELECT LOC
FROM DEPT
WHERE DEPTNO IN (SELECT DEPTNO
...
--92--
/*
DISPLAY EMPNO, ENAME, JOB, WHOSE JOB HAS 'E' IN IT AND DISPLAY EMPNO IN DESCENDING ORDER.
*/
--93--
/*
...
--94--
/*
DISPLAY AVG SALARY OF ALL EMPLOYEES WHOSE DEPT NAME IS ACCOUNTING??
*/
--95--
/*
DISPLAY ALL EMPLOYEES DETAILS WHOSE HIREDATE IS IN YEAR 81??
*/
--96--
/*
DISPLAY DETAILS OF SMITH AND EMPLOYEES WORKING AS PRESIDENT ALONG WITH HIKE OF 35% IN SALARY.
*/
--97--
/*
DISPLAY NUMBER OF EMPLOYEES WHOSE COMMISSION IS MORE THAN SALARY.
*/
--98--
/*
LIST THE EMPLOYEES WHOSE DAILY SALARY IS GREATER THAN 1500 AND WHO ARE JOINED BEFORE 1982 ONLY.
*/
--99--
/*
DISPLAY NUMBER OF EMPLOYEES WHOSE COMMISSION IS MORE THAN SALARY.
...
--101--
/*
DISPLAY ALL THE EMPLOYEES WHOSE JOB SAME AS 'SMITH' AND DEPARTEMENT SAME AS 'JONES' AND SALARY MORE THAN 'TURNER'.
*/
--102--
/*
DISPLAY ALL THE EMPLOYEES WHOSE NAME START WITH 'S' AND HAVING SALARY MORE THAN 'ALLEN' AND LESS THAN FORD.
*/
--103--
/*
...
--104--
/*
DISPLAY DEPARTEMENT NAME WHICH IS HAVING AT LEAST ONE 'MANAGER'.
*/
--105--
/*
DISPLAY MAXIMUM SALARY OF 'SALES' DEPARTMENT.
*/
--106--
/*
...
--107--
/*
DISPLAY THE DEPT NAME OF THE EMP WHO GETS 3RD MAXIMUM SALARY
*/
--108--
/*
