...
FROM EMP, DEPT
WHERE EMP.DEPTNO=DEPT.DEPTNO AND JOB='MANAGER' AND LOC='CHICACO';
...
*/
SELECT MIN(SAL), ROUND(AVG(SAL)), DEPTNO  --HERE I USED SIGNLE ROW FUNCTION, YOU CAN WRITE WITHOUT ROUND() FUNCTION
FROM EMP
GROUP BY DEPTNO
...
--77--
/*
DISPLAY ALL THE EMPLOYEE INFORMATION WHO ARE LIVING IN A LOCATION WHICH IS HAVING AT LEAST 2 'O' IN IT.
*/
...
--79--
/*
DISPLAY THE NAMES OF EMPLOYESS WHO EARN HIGHEST SALARY IN THEIR RESPECTIVE JOBS.
*/
...
--81--
/*
WRITE A QUERY TO FIND SMITH'S MANAGER'S MANAGER HIREDATE.
*/
...
--83--
/*
LIST THE DEEPARTMENT NAMES IN WHICH THE EMPLOYEES ARE HIRED BETWEEN 1ST OF JAN 1981 AND 31ST DEC 1982 WITH SALARY MORE THAN 1800.
*/
...
WHERE DEPTNO IN (SELECT DEPTNO
                    FROM EMP
                        WHERE HIREDATE BETWEEN '02-JAN-1981' AND '30-DEC-1982' AND SAL > 1800);


--84--
/*
DISPLAY LOCATION OF THE EMPLOYEE WHO EARN MAXIMUM SALRY AND HAVE NO REPORTIN MANAGER.
*/
SELECT LOC
FROM DEPT
WHERE DEPTNO IN (SELECT DEPTNO
...
--85--
/*
LIST EMPLOYEES WHO WORKS FOR ACCOUNTING DEPARTMENT AND THEIR SALARY GREATER THAN AVERAGE SALARY OF THEIR DEPARTMENT.
*/
